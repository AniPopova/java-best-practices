...
public class WhatToReturnCollectionSample {

    /**Better return empty collections instead of NULL*/
    ...
    private static void showBadPractice() {
        var numberList = getNaturalNumbersAsStringListBadPractice(5);
        if (numberList != null) {
    ...
    private static void showGoodPractice() {
        getNaturalNumbersAsStringListGoodPractice(5)
