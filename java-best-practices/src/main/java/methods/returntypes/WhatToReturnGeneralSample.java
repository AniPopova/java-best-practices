...
public class WhatToReturnGeneralSample {
    ...
    private static void showBadPractice() {
        ...
        //magical value - aware
        String longestWordMagicalValue = getLongestStringMagicValue(words);
        if (!longestWordMagicalValue.equals("NOT_SUPPORTED")) {
            System.out.println("The longest word is: " + longestWordMagicalValue);
        } else {
        ...
        if (longestWordNull != null) {
            ...
            System.out.println("You did not provide any word!");
        }
    }
